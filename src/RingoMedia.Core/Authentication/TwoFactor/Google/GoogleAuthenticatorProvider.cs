...
namespace RingoMedia.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : RingoMediaServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("RingoMedia", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
