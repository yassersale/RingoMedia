...
namespace RingoMedia.MultiTenancy.Payments.Stripe
{
    public class StripeGatewayManager : RingoMediaServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "RingoMedia";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + RingoMediaConsts.Currency;
        }
