...
using RingoMedia.Authorization.Ldap;
...
using RingoMedia.DashboardCustomization.Definitions;
using RingoMedia.Debugging;
using RingoMedia.DynamicEntityProperties;
using RingoMedia.Features;
using RingoMedia.Friendships;
using RingoMedia.Friendships.Cache;
using RingoMedia.Localization;
using RingoMedia.MultiTenancy;
using RingoMedia.Net.Emailing;
using RingoMedia.Notifications;
using RingoMedia.WebHooks;
using Newtonsoft.Json;

namespace RingoMedia
{
    [DependsOn(
        typeof(RingoMediaCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class RingoMediaCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            RingoMediaLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = RingoMediaConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, RingoMediaMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<RingoMediaSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(RingoMediaCoreModule).GetAssembly());
        }
