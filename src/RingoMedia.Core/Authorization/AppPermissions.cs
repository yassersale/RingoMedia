namespace RingoMedia.Authorization
{
    ...
    {
        public const string Pages_Reminders = "Pages.Reminders";
        public const string Pages_Reminders_Create = "Pages.Reminders.Create";
        public const string Pages_Reminders_Edit = "Pages.Reminders.Edit";
        public const string Pages_Reminders_Delete = "Pages.Reminders.Delete";
