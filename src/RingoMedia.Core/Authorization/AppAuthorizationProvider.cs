...
namespace RingoMedia.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var reminders = pages.CreateChildPermission(AppPermissions.Pages_Reminders, L("Reminders"), multiTenancySides: MultiTenancySides.Host);
            reminders.CreateChildPermission(AppPermissions.Pages_Reminders_Create, L("CreateNewReminder"), multiTenancySides: MultiTenancySides.Host);
            reminders.CreateChildPermission(AppPermissions.Pages_Reminders_Edit, L("EditReminder"), multiTenancySides: MultiTenancySides.Host);
            reminders.CreateChildPermission(AppPermissions.Pages_Reminders_Delete, L("DeleteReminder"), multiTenancySides: MultiTenancySides.Host);

            pages.CreateChildPermission(AppPermissions.Pages_DemoUiComponents, L("DemoUiComponents"));

            var departments = pages.CreateChildPermission(AppPermissions.Pages_Departments, L("Departments"), multiTenancySides: MultiTenancySides.Host);
            departments.CreateChildPermission(AppPermissions.Pages_Departments_Create, L("CreateNewDepartment"), multiTenancySides: MultiTenancySides.Host);
            departments.CreateChildPermission(AppPermissions.Pages_Departments_Edit, L("EditDepartment"), multiTenancySides: MultiTenancySides.Host);
            departments.CreateChildPermission(AppPermissions.Pages_Departments_Delete, L("DeleteDepartment"), multiTenancySides: MultiTenancySides.Host);
        ...
        {
            return new LocalizableString(name, RingoMediaConsts.LocalizationSourceName);
        }
    }
}