...
using RingoMedia.Core.Base;
using RingoMedia.Core.Extensions;
using RingoMedia.Dto;
using RingoMedia.Types;

namespace RingoMedia.Queries
{
    public class OrganizationUnitQuery : RingoMediaQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
