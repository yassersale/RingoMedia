...
namespace RingoMedia.Core.Base
{
    public abstract class RingoMediaQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected RingoMediaQueryBase(string fieldName,
