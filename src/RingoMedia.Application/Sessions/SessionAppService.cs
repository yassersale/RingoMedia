...
namespace RingoMedia.Sessions
{
    ...
    public class SessionAppService : RingoMediaAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = RingoMediaConsts.Currency,
                        CurrencySign = RingoMediaConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = RingoMediaConsts.AllowTenantsToChangeEmailSettings,
