...
using RingoMedia.Migrations.Seed;
using RingoMedia.Migrations.Seed.Host;
...
namespace RingoMedia.Install
{
    ...
    [RemoteService(IsMetadataEnabled = RingoMediaConsts.IsSwaggerShow)]

    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : RingoMediaAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<RingoMediaDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{RingoMediaConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{RingoMediaConsts.ConnectionStringName}", constring);
        }
