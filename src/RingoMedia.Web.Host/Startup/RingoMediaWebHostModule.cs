...
using RingoMedia.Web.Startup.ExternalLoginInfoProviders;
...
namespace RingoMedia.Web.Startup
{
    ...
    public class RingoMediaWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public RingoMediaWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(RingoMediaWebHostModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            //workManager.Add(IocManager.Resolve<CheckRemindersAndSendEmails>());
