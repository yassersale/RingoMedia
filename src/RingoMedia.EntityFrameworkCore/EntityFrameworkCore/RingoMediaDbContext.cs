...
using RingoMedia.MultiTenancy.Accounting;
using RingoMedia.MultiTenancy.Payments;
using RingoMedia.Storage;

namespace RingoMedia.EntityFrameworkCore
{
    public class RingoMediaDbContext : AbpZeroDbContext<Tenant, Role, User, RingoMediaDbContext>, IAbpPersistedGrantDbContext
    {
