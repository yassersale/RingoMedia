...
{
    public class SubscriptionPaymentRepository : RingoMediaRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<RingoMediaDbContext> dbContextProvider)
