...
using RingoMedia.EntityFrameworkCore.Repositories;

namespace RingoMedia.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : RingoMediaRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<RingoMediaDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
