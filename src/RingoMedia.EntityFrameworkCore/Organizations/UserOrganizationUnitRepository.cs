...
namespace RingoMedia.Organizations
{
    public class UserOrganizationUnitRepository : RingoMediaRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<RingoMediaDbContext> dbContextProvider)
