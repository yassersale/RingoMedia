...
{
    public class UserRepository : RingoMediaRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<RingoMediaDbContext> dbContextProvider)
