...
namespace RingoMedia.Web.TagHelpers
{
    ...
    public class RingoMediaPageSubheaderTagHelper : TagHelper
    {
        ...
        public RingoMediaPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
