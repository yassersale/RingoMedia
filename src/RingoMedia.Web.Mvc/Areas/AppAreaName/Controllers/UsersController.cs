...
using RingoMedia.Authorization.Permissions;
...
using RingoMedia.Web.Areas.AppAreaName.Models.Roles;
using RingoMedia.Web.Areas.AppAreaName.Models.Users;
...
namespace RingoMedia.Web.Areas.AppAreaName.Controllers
{
    [Area("AppAreaName")]
    [AbpMvcAuthorize]
    public class UsersController : RingoMediaControllerBase
    {
