...
using RingoMedia.Web.Areas.AppAreaName.Models.Languages;
...
namespace RingoMedia.Web.Areas.AppAreaName.Controllers
{
    ...
    public class LanguagesController : RingoMediaControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = RingoMediaConsts.LocalizationSourceName;
            }
