...
namespace RingoMedia.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameUserMenu
{
    public class AppAreaNameUserMenuViewComponent : RingoMediaViewComponent
    {
